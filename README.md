...
- `NEXT_PUBLIC_BACKEND_URL` (예: `http://localhost:8080` 또는 `http://43.201.97.58.nip.io:8081`)
...
- 3000 포트가 점유 중이면 Next가 자동으로 3001 등 다른 포트를 사용합니다.
...
브라우저에서 아래처럼 보이면:
- `GET http://<host>:8081/ws/info ... 403 (Forbidden)`
